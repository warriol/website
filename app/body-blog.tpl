					...
					<div class="row">
						<div class="col-md-9">
							<div class="blog-posts">
								<!-- POST para galaeria de imagenes -- >
								<article class="post post-large">
									<div class="post-image">
										<div class="owl-carousel" data-plugin-options='{"items":1}'>
											<div>
												<div class="img-thumbnail">
													<img class="img-responsive" src="app/img/blog/blog-image-3.jpg" alt="">
												</div>
											</div>
											<div>
												<div class="img-thumbnail">
													<img class="img-responsive" src="app/img/blog/blog-image-2.jpg" alt="">
												</div>
											</div>
										</div>
									</div>
											...
											<ul class="simple-post-list">
													...
													<div class="post-image">
														<div class="img-thumbnail">
															<a href="blog-post.html">
																<img src="app/imgblog/blog-thumb-1.jpg" alt="">
															</a>
														</div>
													</div>
													<div class="post-info">
												...
												<li>
													<div class="post-image">
														<div class="img-thumbnail">
															<a href="blog-post.html">
																<img src="app/imgblog/blog-thumb-2.jpg" alt="">
															</a>
														</div>
													</div>
													<div class="post-info">
												...
												<li>
													<div class="post-image">
														<div class="img-thumbnail">
															<a href="blog-post.html">
																<img src="app/imgblog/blog-thumb-3.jpg" alt="">
															</a>
														</div>
													</div>
													<div class="post-info">
