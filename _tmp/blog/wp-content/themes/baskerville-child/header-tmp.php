...
<?php wp_head(); ?>
		...
		<?php
			/*
				enlaces importantes para que el tema visual se ajuste al de mi sitio
			*/
    		require('../app/header-meta-blog.tpl'); // no links
...
<!-- 
inicio de body nuevo
para ajustar el blog dentr de mi web
lo debo cerrar el el footer
-->
    <body <?php body_class(); ?>>
    	...
    	<div class="body">
        	...
        	<?php
				include('../app/body-header-blog.tpl'); // hecho
			?>
